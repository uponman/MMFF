...
class Loggers():
    ...
    def on_train_batch_end(self, model, ni, imgs, imgsd, targets, paths, pathsd, vals):
        ...
        if self.plots:
            if ni < 3:
                ...
                fd = self.save_dir / f'train_batch{ni}depth.jpg'
                # plot_images(imgsd, targets, pathsd, fd)
                plot_images(imgs, imgsd, targets, paths, pathsd, f, fd)
